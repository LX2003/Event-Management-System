...
public class OrganizerService {
        ...
        try {
            ...
            for (JsonElement el : array) {
                ...
                if (obj.has("allow_registration")) {
                    e.setAllowRegistration(obj.get("allow_registration").getAsInt() == 1);
                }
    ...
    public static boolean setEventRegistrationAllowed(int eventId, boolean allowed) {
        try {
            URL url = new URL(BASE_URL + "toggleRegistration.php");
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("POST");
            conn.setDoOutput(true);
            conn.setRequestProperty("Content-Type", "application/json");
            ...
            JsonObject obj = new JsonObject();
            obj.addProperty("event_id", eventId);
            obj.addProperty("allow_registration", allowed); // true or false
